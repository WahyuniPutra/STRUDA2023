...
/*fungsi clear akan menghapus isi data didalam array (bukan array)*/
...
cout << "Menu : " << endl;
cout << "\n1. Push \n2. Pop \n3. Change \n4. Peek \n5. Display\n6. Clear \n7. Exit" << endl; //menu
int x; //inisiasi variabel yang digunakan oleh switch dan percabangan if
cout << endl;
...
case 1 :
   ...
   aa:
   cout << "\n1. Kembali Ke Menu Utama \n2. Keluar" << endl; //menu yang ditawarkan kepada user
   cout << "Pilih : "; cin >> x; //mengambil inputan user
   if(x == 1){ 
    goto MainMenu; //jika nilai yg diberikan adalah 1 maka program akan kembali ke menu utama
   }else if(x == 2){
    exit(); // jika nilai yg diberikan adalah 2 maka fungsi exit akan dijalankan
   }else{
    goto aa; // jika user menginput nilai selain 1 dan 2 maka program akan mengulang inputan
   }
    break;
case 2 :
   popTasBelanja();
